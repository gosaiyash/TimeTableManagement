...
<html lang="en">
  <head>
    ...
    <title>Add Services - Time Table Management</title>
    <meta
      ...
      <div class="main-content">
        <div class="container">
          <div class="page-header">
            <h1 class="page-title">Add Services Details</h1>
            <p class="page-description">Add new services to the system</p>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              <form method="POST" action="{{ url('services_add') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="s_name">Service Name</label>
                      <input type="text" class="form-control" id="s_name" name="s_name" placeholder="Enter service name" />
                      @error('s_name')
