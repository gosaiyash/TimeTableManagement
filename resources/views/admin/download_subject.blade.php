...
<html lang="en">
  <head>
    ...
    <title>Download Subject - Time Table Management</title>
    <meta
      ...
      <div class="main-content">
        <div class="container">
          <div class="page-header">
            <h1 class="page-title">Download Subject Data</h1>
            <p class="page-description">View and download all subject information</p>
          </div>
