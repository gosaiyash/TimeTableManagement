...
<html lang="en">
  <head>
    ...
    <title>View Subject - Time Table Management</title>
    <meta
      ...
      <div class="main-content">
        <div class="container">
          <div class="page-header">
            <h1 class="page-title">View Subject Data</h1>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          <a href="{{ route('subupdate', ['id' => $r->id]) }}" class="btn btn-info btn-sm">
                            <i class="fas fa-edit"></i> Edit
                          </a>
                          <a href="{{ route('subdelete', ['id' => $r->id]) }}" class="btn btn-danger btn-sm">
