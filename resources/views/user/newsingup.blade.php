...
<head>
  ...
  <title> Admin Login and Signup Form </title>
  ...
  <section class="container forms">
    ...
    <div class="form signup">
      <div class="form-content">
        ...
        <form action="{{ url('/adminsingupdatasave')}}">
        <div class="field input-field">
            <input type="name" id="name" name="name" placeholder="Name" class="input">
          </div>
          <div class="field input-field">
            <input type="email" id="email" name="email" placeholder="Email" class="input">
          </div>
          <div class="field input-field">
            <input type="roll" id="roll" name="roll" placeholder="Roll" class="input">
          </div>
          <div class="field input-field">
...
links.forEach(link => {
  link.addEventListener("click", e => {
    ...
    var p1 = documenr.GetElementById("#password");
    
    var p2 = documenr.GetElementById("#password1");
