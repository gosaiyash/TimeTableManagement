    ...
    <div class="registration-form">
		...
		@csrf
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control item" name="id" id="id" placeholder="Student Name" >
				@error('firstname')
			...
			<div class="form-group">
                <input type="text" class="form-control item"name="sem"  id="sem" placeholder="Sem">
				@error('sem')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
			</div>
			<div class="form-group">
                <input type="date" class="form-control item" name="birthdate" id="birthdate" placeholder="Birth Date   ex.#dd-mm-yyyy">
				@error('birthdate')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
			...
			<div class="form-group">
				<!-- <p>Student Image :- </p> -->
                <input type="file" class="form-control item" id="student_img" name="student_img" placeholder="Student image">
				@error('student_img')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
			</div>
